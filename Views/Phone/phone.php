...
<html>
    <head>
        <title>Chilli Panda | Phone Administration</title>
            ...
            <div class="section-wrapper">
                <div class="breadcrumbs-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Phone Administration</li>
                    </ol>
                </div>
                <h1 class="administration-title">Phone Administration</h1>
    ...
    if ($webConfig->production == true){
        ?>
        <script data-main="/js/phone/index-built.js" src="/cp-front/js/requireJs/require-jquery.js"></script>
    ...
    ?>
        <script data-main="/js/phone/index.js" src="/cp-front/js/requireJs/require-jquery.js"></script>
        <script type="text/javascript">
            var _apiHost  = "<?php echo $webConfig->cpApiHost; ?>";
            var _enterpriseId = "<?php echo $userHelper->getCurrentEnterpriseId(); ?>";
            var _targetEnterpriseId = "<?php echo $userHelper->getTargetEnterpriseId(); ?>";
