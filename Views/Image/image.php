...
<html>
    <head>
        <title>Chilli Panda | Image Administration</title>
            ...
            <div class="section-wrapper">
                <div class="breadcrumbs-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Image Administration</li>
                    </ol>
                </div>
                <h1 class="administration-title">Image Administration</h1>
