...
<html>
    <head>
        <title>Chilli Panda | Message Administration</title>
            ...
            <div class="section-wrapper">
                <div class="breadcrumbs-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Message Administration</li>
                    </ol>
                </div>
                <h1 class="administration-title">Message Administration</h1>
                ...
                <div id="message-grid-wrapper"></div>
            </div>
        </div>
    ...
    if ($webConfig->production == true){
        ?>
        <script data-main="/js/message/index-built.js" src="/cp-front/js/requireJs/require-jquery.js"></script>
    ...
    ?>
        <script data-main="/js/message/index.js" src="/cp-front/js/requireJs/require-jquery.js"></script>
        <script type="text/javascript">
            var _apiHost  = "<?php echo $webConfig->cpApiHost; ?>";
            var _enterpriseId = "<?php echo $userHelper->getCurrentEnterpriseId(); ?>";
            var _targetEnterpriseId = "<?php echo $userHelper->getTargetEnterpriseId(); ?>";
