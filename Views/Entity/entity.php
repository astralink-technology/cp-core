...
<html>
    <head>
        <title>Chilli Panda | Entity Administration</title>
            ...
            <div class="section-wrapper">
                <div class="breadcrumbs-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Entity Administration</li>
                    </ol>
                </div>
                <h1 class="administration-title">Entity Administration</h1>
                ...
                <div id="entity-grid-wrapper"></div>
            </div>
        </div>
    ...
    if ($webConfig->production == true){
        ?>
        <script data-main="/js/entity/index-built.js" src="/cp-front/js/requireJs/require-jquery.js"></script>
    ...
    ?>
        <script data-main="/js/entity/index.js" src="/cp-front/js/requireJs/require-jquery.js"></script>
        <script type="text/javascript">
            var _apiHost  = "<?php echo $webConfig->cpApiHost; ?>";
            var _enterpriseId = "<?php echo $userHelper->getCurrentEnterpriseId(); ?>";
            var _targetEnterpriseId = "<?php echo $userHelper->getTargetEnterpriseId(); ?>";
