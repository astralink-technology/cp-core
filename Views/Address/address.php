...
<html>
    <head>
        <title>Chilli Panda | Address Administration</title>
            ...
            <div class="section-wrapper">
                <div class="breadcrumbs-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Address Administration</li>
                    </ol>
                </div>
                <h1 class="administration-title">Address Administration</h1>
                ...
                <div id="address-grid-wrapper"></div>
            </div>
        </div>
    ...
    if ($webConfig->production == true){
        ?>
        <script data-main="/js/address/index-built.js" src="/cp-front/js/requireJs/require-jquery.js"></script>
    ...
    ?>
        <script data-main="/js/address/index.js" src="/cp-front/js/requireJs/require-jquery.js"></script>
        <script type="text/javascript">
            var _apiHost  = "<?php echo $webConfig->cpApiHost; ?>";
            var _enterpriseId = "<?php echo $userHelper->getCurrentEnterpriseId(); ?>";
            var _targetEnterpriseId = "<?php echo $userHelper->getTargetEnterpriseId(); ?>";
