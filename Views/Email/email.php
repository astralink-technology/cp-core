...
<html>
    <head>
        <title>Chilli Panda | Email Administration</title>
            ...
            <div class="section-wrapper">
                <div class="breadcrumbs-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Email Administration</li>
                    </ol>
                </div>
                <h1 class="administration-title">Email Administration</h1>
    ...
    if ($webConfig->production == true){
        ?>
        <script data-main="/js/email/index-built.js" src="/cp-front/js/requireJs/require-jquery.js"></script>
    ...
    ?>
        <script data-main="/js/email/index.js" src="/cp-front/js/requireJs/require-jquery.js"></script>
        <script type="text/javascript">
            var _apiHost  = "<?php echo $webConfig->cpApiHost; ?>";
            var _enterpriseId = "<?php echo $userHelper->getCurrentEnterpriseId(); ?>";
            var _targetEnterpriseId = "<?php echo $userHelper->getTargetEnterpriseId(); ?>";
