...
<html>
    <head>
        <title>Chilli Panda | Product Administration</title>
            ...
            <div class="section-wrapper">
                <div class="breadcrumbs-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Product Administration</li>
                    </ol>
                </div>
                <h1 class="administration-title">Product Administration</h1>
                <div class="administration-controls">
                    <ul class="list-inline">
                        <li><button class="btn btn-primary" id="btn-newProduct">New Product</button></li>
    ...
    if ($webConfig->production == true){
        ?>
        <script data-main="/js/product/index-built.js" src="/cp-front/js/requireJs/require-jquery.js"></script>
    ...
    ?>
        <script data-main="/js/product/index.js" src="/cp-front/js/requireJs/require-jquery.js"></script>
        <script type="text/javascript">
            var _apiHost  = "<?php echo $webConfig->cpApiHost; ?>";
            var _enterpriseId = "<?php echo $userHelper->getCurrentEnterpriseId(); ?>";
            var _targetEnterpriseId = "<?php echo $userHelper->getTargetEnterpriseId(); ?>";
