...
<html>
<head>
    <title>Chilli Panda | Product Registration Administration</title>
    ...
    <div class="section-wrapper">
        <div class="breadcrumbs-wrapper">
            <ol class="breadcrumb">
                ...
                <li class="active">Product Registration Administration</li>
            </ol>
        </div>
        <h1 class="administration-title">Product Registration Administration</h1>
        <div class="administration-controls">
            <ul class="list-inline">
                <li><button class="btn btn-primary" id="btn-newProductRegistration">New Registration</button></li>
                <li><button class="btn btn-default" id="btn-documentation" disabled>Documentation</button></li>
            </ul>
        </div>
        <div id="product-registration-grid-wrapper"></div>
    </div>
</div>
