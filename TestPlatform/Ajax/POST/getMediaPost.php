...
<html>
    <head>
        ...
        <script type="text/javascript">
            function addEntity(){
                ...
                parms.DeviceID ="90a783089e9a";

                //alert(JSON.stringify(parms));

                $.ajax({
                    type: "POST",
                    url: "/P2P/media/getMedia",
                    processData: true,
                    ...
                    success: function (json) {
                        if (json){
                           // alert(JSON.stringify(json));
                            $("#json-string").html(JSON.stringify(json));
                        }
                    },
                    error: function (xhr) {
                        alert("error");
    ...
    <body class="test-platform">
        ...
        <div id="root">
            ...
            <section>
                <h1> Get media using JSON POST</h1>
                <div><button class="btn btn-large" id="bt-addEntity">Get Media</button></div>
